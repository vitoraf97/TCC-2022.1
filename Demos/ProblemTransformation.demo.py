# Demo de Processamento dee Inteligência Artificial Multi-Label para detecção de Ataques
...
# Demo para: 20 Features, 150.000 linhas e LabelPowerSet e KNN
...
if __name__ == "__main__":
    ...
    dict_classif_bin = {"Nearest Neighbors": KNeighborsClassifier(3)}
    ...
    # Adicionar para o demo
    reduced_attack_files = reduced_attack_files[2:3]
    print('Teste Demo para 150.000 Linhas')
